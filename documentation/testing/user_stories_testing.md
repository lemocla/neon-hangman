# **TESTING USER STORIES** 
  ...
  - ### **Introduction**: 
    ...
    User stories were tested manually.
     ...
     [click here](README.md) to go back to the main section of the ReadMe. 
 ...
 - #### **T01 Acceptance criteria**
    ...
    - On a mobile or tablet in portrait mode, game elements are rearranged vertically and the game area is visible without srolling.
 ...
 - #### **T02 Acceptance criteria**
    - When I hover on the toggle button, its appearance changes slightly, 
    - When I click on the toggle button, the toggle image changes to a cross and the vertical menu is displayed and,
    - When I click on one of the menu items, its content is displayed whilst other menu items' contents collapse back 
 ...
 - #### **T04 Acceptance criteria**
    ...
    - When I hover on "how to play" button, its appearance darkens slightly and,
    - When I click on "how to play" button, the instructions on how to play the game are displayed clearly, and
    - When I click on "how to play" button" again, the instructions content collapses back.
 ...
 - #### **T05 Acceptance criteria**
    - See T02 Acceptance criteria, and 
    - When I hover on "Settings" button, it appearance darkents slightly and, 
    - When I click on "Settings" button, displaying clearly level, category and sounds section are displayed clearly, and
    ...
    - When I hover on one the buttons in settings, their appearance changes to pink,
    - When I click on any item in each section, 
        - the selected option will be highlighted in bright pink and,
        -  others will be reset to their default format.
        - the game information section of the game will be updated with my preferences
 ...
 - #### **T08 Acceptance criteria**
    - When I hover a key on the interactive keyboard, its appearance darkens slightly and, 
 ...
 - #### **T09 Acceptance criteria**
    - When I start a game, I can see the timer set at 2:00 in the game information section, 
    - With each second passing, I can the timer value going down, 
 ...
 - #### **T11 Acceptance criteria**
    - When I win a game, I can see a button to leave the game, 
    - When I hover over the leave button, its appearance darkens slightly, 
    - When I click on the the leave button,
        -  I am brought back to the home displayed
        -  I can see a button "continue"
        -  My scores are still in the game information 

 - #### **T11 Result after fixes:** PASS
 ...
 - #### **T12 Acceptance criteria**
    - When I exit the page without finishing guessing the hidden word and I return to the game, 
        - The hidden word and my progress are retrieved and displayed 
        - The hangman part are retrieved and displayed, 
        - The keys I have previously pressed are disabled,
        - My score is retrieved and displayed,
        - The countdown timer is retrieved and displayed, 
        as when I left the game.
            
 - #### **T12 Result after fixes:** PASS
 ...
 - #### **T13 Acceptance criteria**
    - When I win a game, a button "continue' is displayed, 
    - When I hover over the "continue" button, its appearance darkens slightly, 
    - When I click on the "continue" button, a new round starts.
    
 - #### **T13 Result after fixes:** PASS
   
 - #### **T14 Acceptance criteria**
    - When the game is over, a button "play gain" is displayed, 
    - When I hover over the "play again" button, its appearance darkens slightly, 
    - When I click on the "play again" button, a new game starts and the score is reset to 0.
    
 - #### **T14 Result after fixes:** PASS
 ...
 - #### **T15 Acceptance criteria**
    - When I look into the game information section, I can see my score and my best score

 - #### **T15 Result after fixes:** PASS

 - #### **T16 Acceptance criteria**
    - TC02,
    - When I hover on "leaderboard" button, its appearance darkens slightly and,
    - When I click on "leadeboard" button, the leaderboard is displayed clearly, showing highest scores first.
    - When I click on "leaderboard" again, the leaderboard content collapses back.
     
 - #### **T16 Result after fixes:** PASS
  
     ![footer](../screenshots/menu_leaderboard.png)
...
>- ### **As a frequent / returning player, I want to contact the company so that I can offer suggestions on how to improve the website.**
 ...
 - #### **T17 Acceptance criteria**
    - when I scroll to the footer of the webpage, the "contact us" buttons and social media icons are displayed and,
 ...
 - #### **T18 Result after fixes:** PASS

     ![success_message](../screenshots/success_message.png)

 - #### **T19 Acceptance criteria - form happy path**
